    ...
    <div className="min-h-screen bg-bartr-bg flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          <h1 className="font-sora font-bold text-2xl text-gray-900 mb-1">Create your account</h1>
          <p className="text-gray-500 font-dm text-sm mb-6">Join 1,200+ students exchanging skills</p>
          ...
          <form onSubmit={handleSubmit(data => mutation.mutate(data))} className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400 font-dm">Use your university email to get verified automatically</p>
            </div>
          ...
          <p className="text-xs text-gray-400 font-dm text-center mt-4">
        ...
        <p className="text-center text-sm text-gray-500 font-dm mt-6">
          ...
          <Link to="/login" className="text-bartr-dark font-semibold hover:underline">Sign in</Link>
        </p>
      </motion.div>
    </div>
  )
