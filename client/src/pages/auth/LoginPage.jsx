...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F5] flex items-center justify-center px-4 portfolio-dots portfolio-theme">
      ...
      >
        ...
        <div className="bg-white rounded-3xl border border-[#0B0B0A]/8 shadow-[0_10px_40px_rgba(11,11,10,0.02)] p-8">
          <h1 className="font-syne font-bold text-2xl text-[#0B0B0A] mb-1">Welcome back</h1>
          <p className="text-[#0B0B0A]/50 font-jakarta text-xs sm:text-sm mb-6 font-medium">Sign in to your Bartr account</p>
          ...
          <form onSubmit={handleSubmit(data => mutation.mutate(data))} className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-2 text-right">
                <Link to="/forgot-password" className="text-xs text-[#0B0B0A]/40 hover:text-[#6D28D9] font-bold font-jakarta transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>
        ...
        <p className="text-center text-xs text-[#0B0B0A]/40 font-jakarta mt-6">
          ...
          <Link to="/register" className="text-[#6D28D9] font-bold hover:underline">Sign up</Link>
        </p>
      </motion.div>
    </div>
  )
