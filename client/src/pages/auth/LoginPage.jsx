    ...
    <div className="min-h-screen bg-bartr-bg flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="bg-bartr-card rounded-2xl border border-bartr-border shadow-sm p-8">
         ...
         <a href={`${getBaseURL()}/auth/google`}  className="w-full flex items-center justify-center gap-3 border border-bartr-border rounded-full py-2.5 text-sm font-semibold font-sora text-bartr-text hover:bg-bartr-surface transition-colors">
